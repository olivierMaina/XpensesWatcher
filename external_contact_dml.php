...
function external_contact_insert(){
	...
	$data['poste'] = makeSafe($_POST['poste']);
		if($data['poste'] == empty_lookup_value){ $data['poste'] = ''; }
	...
	sql('insert into `external_contact` set       `last_name`=' . (($data['last_name'] !== '' && $data['last_name'] !== NULL) ? "'{$data['last_name']}'" : 'NULL') . ',`first_name`=' . (($data['first_name'] !== '' && $data['first_name'] !== NULL) ? "'{$data['first_name']}'" : 'NULL') . ',`poste`=' . (($data['poste'] !== '' && $data['poste'] !== NULL) ? "'{$data['poste']}'" : 'NULL') . ',`company_name`=' . (($data['company_name'] !== '' && $data['company_name'] !== NULL) ? "'{$data['company_name']}'" : 'NULL') . ', `email`=' . (($data['email'] !== '' && $data['email'] !== NULL) ? "'{$data['email']}'" : 'NULL') . ', `phone`=' . (($data['phone'] !== '' && $data['phone'] !== NULL) ? "'{$data['phone']}'" : 'NULL') . ', `alternate_phone`=' . (($data['alternate_phone'] !== '' && $data['alternate_phone'] !== NULL) ? "'{$data['alternate_phone']}'" : 'NULL') . ', `country`=' . (($data['country'] !== '' && $data['country'] !== NULL) ? "'{$data['country']}'" : 'NULL') . ',`info`=' . (($data['info'] !== '' && $data['info'] !== NULL) ? "'{$data['info']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function external_contact_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `pirl_dashboard` where `external_contact_name`='".addslashes($id[0])."'", $eo);
...
function external_contact_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `external_contact` set    `last_name`=' . (($data['last_name'] !== '' && $data['last_name'] !== NULL) ? "'{$data['last_name']}'" : 'NULL') . ',`first_name`=' . (($data['first_name'] !== '' && $data['first_name'] !== NULL) ? "'{$data['first_name']}'" : 'NULL') . ',`poste`=' . (($data['poste'] !== '' && $data['poste'] !== NULL) ? "'{$data['poste']}'" : 'NULL') . ',`company_name`=' . (($data['company_name'] !== '' && $data['company_name'] !== NULL) ? "'{$data['company_name']}'" : 'NULL') . ', `email`=' . (($data['email'] !== '' && $data['email'] !== NULL) ? "'{$data['email']}'" : 'NULL') . ', `phone`=' . (($data['phone'] !== '' && $data['phone'] !== NULL) ? "'{$data['phone']}'" : 'NULL') . ', `alternate_phone`=' . (($data['alternate_phone'] !== '' && $data['alternate_phone'] !== NULL) ? "'{$data['alternate_phone']}'" : 'NULL') . ', `country`=' . (($data['country'] !== '' && $data['country'] !== NULL) ? "'{$data['country']}'" : 'NULL') . ',`info`=' . (($data['info'] !== '' && $data['info'] !== NULL) ? "'{$data['info']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
...
function external_contact_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		...
		$jsReadOnly .= "\tjQuery('#poste').replaceWith('<div class=\"form-control-static\" id=\"poste\">' + (jQuery('#poste').val() || '') + '</div>');\n";
	...
	$templateCode=str_replace('<%%UPLOADFILE(poste)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		$templateCode=str_replace('<%%VALUE(poste)%%>', htmlspecialchars($row['poste'], ENT_QUOTES), $templateCode);
		$templateCode=str_replace('<%%URLVALUE(poste)%%>', urlencode($urow['poste']), $templateCode);
		...
		$templateCode=str_replace('<%%VALUE(poste)%%>', '', $templateCode);
		$templateCode=str_replace('<%%URLVALUE(poste)%%>', urlencode(''), $templateCode);
