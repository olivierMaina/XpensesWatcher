...
<?php $current_table = 'external_contact'; ?>
<script>
			...
			<table class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][5]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][5]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="mailto:<?php echo $record[3]; ?>" class="btn btn-info" title="<?php echo html_attr($record[5]); ?>"><i class="glyphicon glyphicon-envelope"></i></a></td>
