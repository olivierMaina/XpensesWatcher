				...
				<table class="table">
					...
					<tr>
						<td align="center">
							Show records from
							<?php
								$arrFields=array('', 'pirl_dashboard', 'external_entity', 'external_contact', 'internal_contact');
								$arrFieldCaptions=array('All tables', 'PIRL Dashboard', 'External entity', 'External contact', 'Internal contact');
