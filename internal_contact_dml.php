...
function internal_contact_insert(){
	...
	sql('insert into `internal_contact` set      `cec`=' . (($data['cec'] !== '' && $data['cec'] !== NULL) ? "'{$data['cec']}'" : 'NULL') . ', `last_name`=' . (($data['last_name'] !== '' && $data['last_name'] !== NULL) ? "'{$data['last_name']}'" : 'NULL') . ',`first_name`=' . (($data['first_name'] !== '' && $data['first_name'] !== NULL) ? "'{$data['first_name']}'" : 'NULL') . ',`poste`=' . (($data['poste'] !== '' && $data['poste'] !== NULL) ? "'{$data['poste']}'" : 'NULL') . ', `email`=' . (($data['email'] !== '' && $data['email'] !== NULL) ? "'{$data['email']}'" : 'NULL') . ', `phone`=' . (($data['phone'] !== '' && $data['phone'] !== NULL) ? "'{$data['phone']}'" : 'NULL') . ', `country`=' . (($data['country'] !== '' && $data['country'] !== NULL) ? "'{$data['country']}'" : 'NULL') . ',`info`=' . (($data['info'] !== '' && $data['info'] !== NULL) ? "'{$data['info']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function internal_contact_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `pirl_dashboard` where `internal_contact_name`='".addslashes($id[0])."'", $eo);
...
function internal_contact_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `internal_contact` set    `cec`=' . (($data['cec'] !== '' && $data['cec'] !== NULL) ? "'{$data['cec']}'" : 'NULL') . ', `last_name`=' . (($data['last_name'] !== '' && $data['last_name'] !== NULL) ? "'{$data['last_name']}'" : 'NULL') . ',`first_name`=' . (($data['first_name'] !== '' && $data['first_name'] !== NULL) ? "'{$data['first_name']}'" : 'NULL') . ',`poste`=' . (($data['poste'] !== '' && $data['poste'] !== NULL) ? "'{$data['poste']}'" : 'NULL') . ', `email`=' . (($data['email'] !== '' && $data['email'] !== NULL) ? "'{$data['email']}'" : 'NULL') . ', `phone`=' . (($data['phone'] !== '' && $data['phone'] !== NULL) ? "'{$data['phone']}'" : 'NULL') . ', `country`=' . (($data['country'] !== '' && $data['country'] !== NULL) ? "'{$data['country']}'" : 'NULL') . ',`info`=' . (($data['info'] !== '' && $data['info'] !== NULL) ? "'{$data['info']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
